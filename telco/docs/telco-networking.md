...
- On-premises networks for telco customers 
- Access
- Core
...
Many telco workloads in on-premises network require communication across two or more of such VRFs, and would require similar isolation when such applications are migrated to or deployed as net-new applications in Azure.
